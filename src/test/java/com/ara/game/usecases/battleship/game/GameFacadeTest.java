...
class GameFacadeTest {
    ...
    void test1() {
        ...
        GameCreateDto inputData = GameCreateDto.builder().firstPlayer(firstPlayer).size(10).build();
        // When
    ...
    void test2() {
        ...
        GameJoinerDto joiner = GameJoinerDto.builder().game(game.get()).playerToJoin(secondPlayer).build();
        //When
